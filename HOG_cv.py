...
if __name__ == '__main__':
    ...
    if not os.path.exists('train_data.pkl'):
        ...
        pickle.dump(train_data, open("../experience4/train_data.pkl", 'wb'))
        pickle.dump(test_data, open("../experience4/test_data.pkl", 'wb'))
        pickle.dump(image_type, open("../experience4/image_type.pkl", 'wb'))
    else:
        train_data=pickle.load(open("../experience4/train_data.pkl", 'rb'))
        test_data=pickle.load(open("../experience4/test_data.pkl", 'rb'))
        image_type=pickle.load(open("../experience4/image_type.pkl", 'rb'))
